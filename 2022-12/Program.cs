...
ShortestPathResult result = graph.Dijkstra(
    (GtConfig.Instance.STARTROW * 1000) + GtConfig.Instance.STARTCOL,
    (GtConfig.Instance.ENDROW * 1000) + GtConfig.Instance.ENDCOL, 200); //result contains the shortest path
